...
<img width="623" alt="Screen Shot 2020-09-26 at 1 53 30 PM" src="https://user-images.githubusercontent.com/69806770/94349705-0ef23680-0015-11eb-8a06-0465f4a78cb8.png">
...
<img width="704" alt="Screen Shot 2020-09-26 at 4 44 29 PM" src="https://user-images.githubusercontent.com/69806770/94349966-a062a800-0017-11eb-8949-f0a6dd433c2e.png">

## Summary
Based on the data results presented above there is a major discrepency in results between the three city types with PyBer performing better in urban cities than anywhere else. There are a few things that PyBer can consider doing to minimize the discrepency. First, they can reduce the fare prices in the rural and suburban cities. This could be a major contributor to why there are lower total rides in these cities. Second, they could increase the number of drivers in the rural and suburban areas as this could be another reason for the lower number of total rides. The demand might be there but not enough drivers are available to complete the rides. Lastly, by improving the prior two points, they can increase their total rides in both rural and suburban areas. This will increase the total fares and average fares per driver and ride as we saw for the urban city results.
